...
## 🧭 Master Mathematical Terminology Index

This course is intrinsically linked to our standalone, cross-referenced mathematical repository in [`MathsTerms/`](../MathsTerms/README.md). Below is the comprehensive taxonomy of mathematical pillars supporting the entire curriculum:

| Category | Pedagogical Domain | Key Mathematical Guides |
| :--- | :--- | :--- |
| **01** | **Primal Analysis & Foundations** | [Probability Basics & Axioms](../MathsTerms/01-Primal-Analysis-and-Foundations/01-Probability_Basics_and_Axioms.md) · [Lipschitz Continuity](../MathsTerms/01-Primal-Analysis-and-Foundations/04-Lipschitz_Continuity.md) · [Convexity & Jensen's Inequality](../MathsTerms/01-Primal-Analysis-and-Foundations/03-Convexity_and_Jensens_Inequality.md) · [Dual Spaces & Norm Duality](../MathsTerms/01-Primal-Analysis-and-Foundations/05-Fenchel_Conjugate_and_Dual_Representations.md) · [Fenchel Conjugate](../MathsTerms/01-Primal-Analysis-and-Foundations/05-Fenchel_Conjugate_and_Dual_Representations.md) |
| **02** | **Linear Algebra, Geometry & Tensors** | [Vectors & Matrices](../MathsTerms/02-Linear-Algebra-Geometry-and-Tensors/01-Vectors_and_Matrices.md) · [Vector Norms & Inner Products](../MathsTerms/02-Linear-Algebra-Geometry-and-Tensors/02-Vector_Norms_and_Inner_Products.md) · [Tensors & Shapes](../MathsTerms/02-Linear-Algebra-Geometry-and-Tensors/04-Tensors_and_Shapes.md) · [Tensor Broadcasting](../MathsTerms/02-Linear-Algebra-Geometry-and-Tensors/05-Tensor_Broadcasting.md) · [SVD](../MathsTerms/02-Linear-Algebra-Geometry-and-Tensors/06-Singular_Value_Decomposition.md) · [Categorical Encodings & Embeddings](../MathsTerms/02-Linear-Algebra-Geometry-and-Tensors/08-Encodings_Categorical_and_Embeddings.md) |
| **03** | **Multivariate Calculus & Optimization** | [Derivatives & Rules](../MathsTerms/03-Multivariate-Calculus-and-Optimization/01-Functions_Derivatives_and_Rules.md) · [Gradients](../MathsTerms/03-Multivariate-Calculus-and-Optimization/02-Derivatives_Gradients_and_Jacobians.md) · [Jacobian Matrix](../MathsTerms/03-Multivariate-Calculus-and-Optimization/03-Jacobian_Matrix.md) · [Chain Rule & Backprop](../MathsTerms/03-Multivariate-Calculus-and-Optimization/04-Chain_Rule_and_Backpropagation.md) · [Activation Functions](../MathsTerms/03-Multivariate-Calculus-and-Optimization/05-Activation_Functions.md) · [Softmax](../MathsTerms/03-Multivariate-Calculus-and-Optimization/06-Softmax.md) · [Loss Functions](../MathsTerms/03-Multivariate-Calculus-and-Optimization/08-Loss_Functions.md) · [Optimization Algorithms](../MathsTerms/03-Multivariate-Calculus-and-Optimization/09-Gradient_Descent.md) · [Batch Norm & Spectral Norm](../MathsTerms/03-Multivariate-Calculus-and-Optimization/11-Batch_Normalization_and_Spectral_Norm.md) |
| **04** | **Probability & Statistical Estimation** | [Random Variables & Distributions](../MathsTerms/04-Probability-and-Statistical-Estimation/01-Random_Variables_and_Distributions.md) · [Common Distributions](../MathsTerms/04-Probability-and-Statistical-Estimation/02-Common_Probability_Distributions.md) · [Joint, Marginal, & Conditional](../MathsTerms/04-Probability-and-Statistical-Estimation/03-Joint_Marginal_Conditional_Dist.md) · [Likelihood & Log-Likelihood](../MathsTerms/04-Probability-and-Statistical-Estimation/04-Likelihood_and_Log_Likelihood.md) · [Maximum Likelihood Estimation (MLE)](../MathsTerms/04-Probability-and-Statistical-Estimation/05-MLE.md) · [MAP Estimation](../MathsTerms/04-Probability-and-Statistical-Estimation/06-NLL.md) |
| **05** | **Information Theory & Divergences** | [Entropy & Cross-Entropy](../MathsTerms/05-Information-Theory-and-Divergences/01-Entropy_CrossEntropy_CCE.md) · [KL Divergence](../MathsTerms/05-Information-Theory-and-Divergences/02-KL_Divergence.md) · [Jensen-Shannon Divergence](../MathsTerms/05-Information-Theory-and-Divergences/03-Jensen_Shannon_Divergence.md) · [f-Divergence](../MathsTerms/05-Information-Theory-and-Divergences/04-f_Divergence.md) · [Wasserstein Distance](../MathsTerms/05-Information-Theory-and-Divergences/05-Wasserstein_Distance_and_EMD.md) |
| **06** | **Deep Architectures & Generative Models** | [Convolution & Pooling](../MathsTerms/06-Deep-Architectures-and-Generative-Models/01-Convolution_and_Pooling.md) · [Autoregressive Models](../MathsTerms/06-Deep-Architectures-and-Generative-Models/04-Autoregressive_Models.md) · [Transformers & Attention](../MathsTerms/06-Deep-Architectures-and-Generative-Models/04-Autoregressive_Models.md) · [Latent Variable Models](../MathsTerms/06-Deep-Architectures-and-Generative-Models/05-Latent_Variable_Models.md) · [Reparameterization Trick](../MathsTerms/06-Deep-Architectures-and-Generative-Models/08-Reparameterization_Trick.md) · [ELBO & Variational Inference](../MathsTerms/06-Deep-Architectures-and-Generative-Models/07-ELBO_and_Variational_Inference.md) · [Diffusion & Score Matching](../MathsTerms/06-Deep-Architectures-and-Generative-Models/07-ELBO_and_Variational_Inference.md) · [Minimax Games & GANs](../MathsTerms/06-Deep-Architectures-and-Generative-Models/09-Minimax_Game_and_GANs.md) · [Wasserstein GAN (WGAN-GP)](../MathsTerms/06-Deep-Architectures-and-Generative-Models/09-Minimax_Game_and_GANs.md) |

For interactive visual dependency flowcharts, visit the **[Grand Unified Concept Map](../MathsTerms/CONCEPT_MAP.md)**.
