...
|:---|:---|:---|
| [Lec 12: VQ-VAE Foundations](../36-Lec12-Vector-Quantised-VAE/NOTES.md) | Theoretical formulation of discrete codebooks | Establishes the tripartite loss and STE theory implemented in this tutorial |
| [Tutorial 15: VAE & Beta-VAE](../39-Tutorial15-VAE-Beta-VAE-Implementation/NOTES.md) | Continuous latent autoencoders | Contrasts continuous Gaussian bottlenecks with discrete codebook lookups |
