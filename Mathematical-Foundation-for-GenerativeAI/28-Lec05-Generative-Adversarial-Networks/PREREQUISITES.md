...
| **$\arg\min_\theta \max_w \mathcal{J}$** | Minimax Saddle-Point Optimization | Alternating PyTorch optimizer steps (`opt_D`, `opt_G`) | A competitive zero-sum board game between two grandmasters. | [f-Divergence](../../../MathsTerms/f_Divergence.md) |
