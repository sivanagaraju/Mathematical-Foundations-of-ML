...
> Continues [Lec 05 GANs](../15-Lec05-Generative-Adversarial-Networks/NOTES.md) and [Tutorial 12](../16-Tutorial12-Implementations-Vanilla-GAN-DCGAN-cGAN/NOTES.md). Wasserstein geometry is [Lec 18](../17-Lec06-Wasserstein-GAN/) (package in progress).  
...
| :--- | :--- | :--- | :--- |
| **$x \in \mathbb{R}^D$** | Ambient Image Vector | High-dimensional pixel array ($D=784$ or $12288$) | [Tensors & Shapes](../../MathsTerms/01-Linear-Algebra-Geometry-and-Tensors/04-Tensors_and_Shapes.md) |
...
| **$z^* = \arg\min_z \|x - G(z)\|^2$** | Direct Optimization Inversion | Gradient descent on latent code to reconstruct target photo | [Gradient Descent](../../MathsTerms/02-Multivariate-Calculus-and-Optimization/09-Gradient_Descent.md) |
| **$W_2^2(P_r, P_g)$** | 2-Wasserstein Distance | Quadratic optimal transport cost between feature Gaussians | [Wasserstein Distance & EMD](../../MathsTerms/04-Information-Theory-and-Divergences/05-Wasserstein_Distance_and_EMD.md) |
...
| **$\text{BiGAN} / \text{ALI}$** | Joint Adversarial Matching | Discriminator matching joint pairs $(x, E(x))$ vs $(G(z), z)$ | [Joint, Marginal & Conditional Dist](../../MathsTerms/03-Probability-and-Statistical-Estimation/03-Joint_Marginal_Conditional_Dist.md) |
