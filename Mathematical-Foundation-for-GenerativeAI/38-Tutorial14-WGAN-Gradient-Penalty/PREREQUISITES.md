...
|:---|:---|:---|
| [Tutorial 13: WGAN Weight Clipping](../37-Tutorial13-WGAN-Weight-Clipping/NOTES.md) | Weight clipping failures and 1-Lipschitz dual constraints | Shows why hard parameter bounding must be replaced with a gradient penalty |
| [MathsTerms: Lipschitz Continuity](../../MathsTerms/01-Primal-Analysis-and-Foundations/04-Lipschitz_Continuity.md) | Gradient norm bounds and Lipschitz constants | Formulates the equivalence $\|\nabla f(x)\|_2 \le 1 \iff \|f\|_L \le 1$ |
