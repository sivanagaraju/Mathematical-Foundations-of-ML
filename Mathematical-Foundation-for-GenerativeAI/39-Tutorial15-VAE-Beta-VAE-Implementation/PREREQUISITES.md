...
|:---|:---|:---|
| [Lec 10: VAEs Part 2](../34-Lec10-VAEs-Part2/NOTES.md) | ELBO derivation and reparameterization theory | Establishes the mathematical equations implemented in this tutorial |
| [Lec 11: Beta-VAE](../35-Lec11-Beta-VAE/NOTES.md) | Constrained optimization and information bottleneck | Explains why scaling $\beta$ encourages factor disentanglement |
