...
| :--- | :--- | :--- | :--- | :--- |
| $D_{\text{KL}}(P \parallel Q)$ | **DEE KAY-EL OF PEE PAR-uh-lel KYOO** | Kullback-Leibler Divergence | Extra bits wasted when coding symbols from true distribution $P$ using candidate model $Q$ | [KL Divergence](../../MathsTerms/04-Information-Theory-and-Divergences/02-KL_Divergence.md) |
| $H(P, Q) = -\sum_x P(x)\log Q(x)$ | **AYCH OF PEE COMMA KYOO** | Cross-Entropy | Average code length when data is generated by $P$ but encoded with code optimized for $Q$ | [Entropy & Cross-Entropy](../../MathsTerms/04-Information-Theory-and-Divergences/01-Entropy_CrossEntropy_CCE.md) |
| $D_{\text{KL}}(P \parallel Q) = H(P, Q) - H(P)$ | **KAY-EL EQUALS CROSS-ENTROPY MINUS ENTROPY** | Divergence Decomposition | Difference between suboptimal code length and fundamental Shannon limit | [KL Divergence](../../MathsTerms/04-Information-Theory-and-Divergences/02-KL_Divergence.md) |
| $D_{\text{KL}}(P \parallel Q) \ge 0$ | **KAY-EL GREATER THAN OR EQUAL TO ZERO** | Gibbs' Inequality / Information Inequality | KL is always non-negative, equaling 0 if and only if $P = Q$ almost everywhere | [KL Divergence](../../MathsTerms/04-Information-Theory-and-Divergences/02-KL_Divergence.md) |
| $D_{\text{KL}}(P \parallel Q) \neq D_{\text{KL}}(Q \parallel P)$ | **KAY-EL IS ASYMMETRIC** | Non-Symmetry (Not a Metric) | Distance from reality to model is not equal to distance from model to reality | [KL Divergence](../../MathsTerms/04-Information-Theory-and-Divergences/02-KL_Divergence.md) |
...
| Prerequisite Concept | Source Module / Resource | Target Application in Lecture 12 | Verification Check |
| :--- | :--- | :--- | :--- |
| **Continuous Densities & Volume Integrals** | [Lecture 09: Density Function](../../Mathematical-foundation-ml/10-Lec09-Density-Function/NOTES.md) | Integrating continuous densities in continuous relative entropy $\int p(x)\log(p(x)/q(x))dx$ | Verify integral normalization to 1 |
