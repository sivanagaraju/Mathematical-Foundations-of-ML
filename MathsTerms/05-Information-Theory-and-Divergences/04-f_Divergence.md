...
> - **[Convexity & Jensen's Inequality](../01-Primal-Analysis-and-Foundations/03-Convexity_and_Jensens_Inequality.md)** — Csiszar generator convex function $f(u)$ where $f(1)=0$ ensuring $D_f(P \parallel Q) \ge 0$
> - **[KL Divergence](./02-KL_Divergence.md)** — Canonical $f$-divergence instance $f(u) = u \ln u$
> - **[Fenchel Conjugate & Duality](../01-Primal-Analysis-and-Foundations/05-Fenchel_Conjugate_and_Dual_Representations.md)** — Variational dual representation $D_f(P \parallel Q) = \sup_T \mathbb{E}_P[T] - \mathbb{E}_Q[f^*(T)]$
>
