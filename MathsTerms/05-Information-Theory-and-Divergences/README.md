...
| **07** | **[Joint & Conditional Entropy & Mutual Information](./07-Joint_Conditional_Entropy_and_Mutual_Information.md)** | Multi-variable information, 2D area grids, Kraft's code budget, Information Venn diagrams, continuous differential vs invariant MI | [Entropy, Cross-Entropy & CCE](./01-Entropy_CrossEntropy_CCE.md), [Joint, Marginal & Conditional Distributions](../04-Probability-and-Statistical-Estimation/03-Joint_Marginal_Conditional_Dist.md), [KL Divergence](./02-KL_Divergence.md) | Multi-modal alignment (CLIP / InfoNCE), MINE, and Information Bottleneck |
