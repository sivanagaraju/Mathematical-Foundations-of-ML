...
> `📚 Prerequisites Needed:` [Tensors & Shapes](./Tensors_and_Shapes.md) (Tensor ranks, shapes, dimensions, and contiguous memory stride layouts) · [Vectors & Matrices](./Vectors_and_Matrices.md) (Matrix-vector shape compatibility in affine linear layers ($y = Wx + b$))
...
> - **[Tensors & Shapes](./Tensors_and_Shapes.md)** — Tensor ranks, shapes, dimensions, and contiguous memory stride layouts
> - **[Vectors & Matrices](./Vectors_and_Matrices.md)** — Matrix-vector shape compatibility in affine linear layers ($y = Wx + b$)
>
