...
> `📚 Prerequisites Needed:` [Vectors & Matrices](./Vectors_and_Matrices.md) (Standard orthonormal basis vectors $\vec{e}_k$ in $\mathbb{R}^V$)
...
> - **[Vectors & Matrices](./Vectors_and_Matrices.md)** — Standard orthonormal basis vectors $\vec{e}_k$ in $\mathbb{R}^V$
>
