...
> `📚 Prerequisites Needed:` [Vectors & Matrices](./Vectors_and_Matrices.md) (Vector definitions, components, and coordinate representations in $\mathbb{R}^d$) · [Vector Norms & Inner Products](./Vector_Norms_and_Inner_Products.md) (Euclidean $L_2$ norm $\|\vec{a}\|_2$ and cosine similarity projection $\cos\theta$)
...
> - **[Vectors & Matrices](./Vectors_and_Matrices.md)** — Vector definitions, components, and coordinate representations in $\mathbb{R}^d$
> - **[Vector Norms & Inner Products](./Vector_Norms_and_Inner_Products.md)** — Euclidean $L_2$ norm $\|\vec{a}\|_2$ and cosine similarity projection $\cos\theta$
>
