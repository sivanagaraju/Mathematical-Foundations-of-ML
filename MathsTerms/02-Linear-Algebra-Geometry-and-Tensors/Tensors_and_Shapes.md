...
> `📚 Prerequisites Needed:` [Vectors & Matrices](./Vectors_and_Matrices.md) (1D vectors, 2D matrices, column-major vs row-major coordinate systems, and matrix dimensions)
...
> - **[Vectors & Matrices](./Vectors_and_Matrices.md)** — 1D vectors, 2D matrices, column-major vs row-major coordinate systems, and matrix dimensions
>
