...
> `📚 Prerequisites Needed:` [Dot Product & Similarity](./Dot_Product_and_Similarity.md) (Attention dot products $\langle q, k \rangle$ and angular rotation invariance in RoPE) · [Encodings & Embeddings](./Encodings_Categorical_and_Embeddings.md) (Token embedding vectors in Transformer architectures) · [Vectors & Matrices](./Vectors_and_Matrices.md) (2D Givens rotation matrices and block-diagonal linear transformations)
...
> - **[Dot Product & Similarity](./Dot_Product_and_Similarity.md)** — Attention dot products $\langle q, k \rangle$ and angular rotation invariance in RoPE
> - **[Encodings & Embeddings](./Encodings_Categorical_and_Embeddings.md)** — Token embedding vectors in Transformer architectures
> - **[Vectors & Matrices](./Vectors_and_Matrices.md)** — 2D Givens rotation matrices and block-diagonal linear transformations
>
