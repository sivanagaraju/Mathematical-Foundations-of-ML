...
> - **[Vectors & Matrices](./01-Vectors_and_Matrices.md)** — Matrix multiplication, transpose $A^T$, matrix rank, and symmetric matrices $A^T A$
> - **[Vector Norms & Inner Products](./02-Vector_Norms_and_Inner_Products.md)** — Spectral norm, Frobenius norm, and geometric length preservation under orthogonal transforms
>
