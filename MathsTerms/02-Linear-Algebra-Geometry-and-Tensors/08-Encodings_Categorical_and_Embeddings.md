...
> - **[One-Hot Encoding](./07-One_Hot_Encoding.md)** — Sparse canonical basis vectors $\vec{e}_i \in \{0, 1\}^V$
> - **[Vectors & Matrices](./01-Vectors_and_Matrices.md)** — Matrix-vector lookup operations $E = W_{\text{emb}} \vec{e}_i$ and continuous vector coordinates
>
