...
> `📚 Prerequisites Needed:` [Bounds, Supremum & Linear Families](./02-Bounds_Supremum_Infimum_and_Linear_Families.md) (Least upper bounds and the envelope of linear supporting lines) · [Convexity & Jensen's Inequality](./01-Convexity_and_Jensens_Inequality.md) (Convex functions, epigraphs, supporting hyperplanes, and subgradients) · [Dot Product & Similarity](../01-Linear-Algebra-Geometry-and-Tensors/03-Dot_Product_and_Similarity.md) (Inner products $\langle t, u \rangle$ and dual vector spaces) · [Functions, Derivatives & Rules](../02-Multivariate-Calculus-and-Optimization/01-Functions_Derivatives_and_Rules.md) (Supremum optimization and stationarity conditions ($t = f'(u)$))  
...
> - **What do I need first?** [Bounds, Supremum, Infimum & Linear Families](./02-Bounds_Supremum_Infimum_and_Linear_Families.md) for $\sup$ and supporting lines, and [Convexity & Jensen's Inequality](./01-Convexity_and_Jensens_Inequality.md) for convex functions.
...
> - **[Bounds, Supremum & Linear Families](./02-Bounds_Supremum_Infimum_and_Linear_Families.md)** — Least upper bounds ($\sup$) and the envelope of supporting lines $y = tu - c(t)$
> - **[Convexity & Jensen's Inequality](./01-Convexity_and_Jensens_Inequality.md)** — Convex functions, epigraphs, supporting hyperplanes, and subgradients
> - **[Dot Product & Similarity](../01-Linear-Algebra-Geometry-and-Tensors/03-Dot_Product_and_Similarity.md)** — Inner products $\langle t, u \rangle$ and dual vector spaces
> - **[Functions, Derivatives & Rules](../02-Multivariate-Calculus-and-Optimization/01-Functions_Derivatives_and_Rules.md)** — Supremum optimization and stationarity conditions ($t = f'(u)$)
...
- **The Solution:** $\sup$ denotes the least upper bound even when no maximizer exists. Optimizing a neural class gives the best bound found in that class; its tightness depends on representation capacity, optimization, and data. (See [Bounds, Supremum & Linear Families](./02-Bounds_Supremum_Infimum_and_Linear_Families.md).)
