...
> `📚 Prerequisites Needed:` [Maximum Likelihood Estimation (MLE)](./MLE.md) (Equivalence between maximizing log-likelihood and minimizing NLL ($\mathcal{L}_{\text{NLL}} = -\ell(\theta)$)) · [Logarithms & Exponential Functions](../01-Primal-Analysis-and-Foundations/Logarithms_and_Exponential_Functions.md) (Log-loss penalties and numerical stability) · [Loss Functions in Machine Learning](../03-Multivariate-Calculus-and-Optimization/Loss_Functions.md) (Cross-entropy loss as empirical risk minimization)
...
> - **[Maximum Likelihood Estimation (MLE)](./MLE.md)** — Equivalence between maximizing log-likelihood and minimizing NLL ($\mathcal{L}_{\text{NLL}} = -\ell(\theta)$)
> - **[Logarithms & Exponential Functions](../01-Primal-Analysis-and-Foundations/Logarithms_and_Exponential_Functions.md)** — Log-loss penalties and numerical stability
> - **[Loss Functions in Machine Learning](../03-Multivariate-Calculus-and-Optimization/Loss_Functions.md)** — Cross-entropy loss as empirical risk minimization
>
