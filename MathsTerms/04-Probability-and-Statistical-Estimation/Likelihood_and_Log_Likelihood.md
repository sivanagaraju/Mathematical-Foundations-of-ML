...
> `📚 Prerequisites Needed:` [Joint, Marginal & Conditional Dist](./Joint_Marginal_Conditional_Dist.md) (I.I.D. joint product factorization $p(X \mid \theta) = \prod_{i=1}^N p(x_i \mid \theta)$) · [Logarithms & Exponential Functions](../01-Primal-Analysis-and-Foundations/Logarithms_and_Exponential_Functions.md) (Converting likelihood products into numerically tractable additive log-sums $\ln \prod = \sum \ln$)
...
> - **[Joint, Marginal & Conditional Dist](./Joint_Marginal_Conditional_Dist.md)** — I.I.D. joint product factorization $p(X \mid \theta) = \prod_{i=1}^N p(x_i \mid \theta)$
> - **[Logarithms & Exponential Functions](../01-Primal-Analysis-and-Foundations/Logarithms_and_Exponential_Functions.md)** — Converting likelihood products into numerically tractable additive log-sums $\ln \prod = \sum \ln$
>
