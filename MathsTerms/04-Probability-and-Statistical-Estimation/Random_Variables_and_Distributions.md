...
> `📚 Prerequisites Needed:` [Probability Basics & Axioms](../01-Primal-Analysis-and-Foundations/Probability_Basics_and_Axioms.md) (Probability space $(\Omega, \mathcal{F}, P)$, events, and measure mappings) · [Functions, Derivatives & Rules](../03-Multivariate-Calculus-and-Optimization/Functions_Derivatives_and_Rules.md) (Continuous density integration $\int p(x) dx = 1$ and derivative relations $p(x) = F'(x)$)
...
> - **[Probability Basics & Axioms](../01-Primal-Analysis-and-Foundations/Probability_Basics_and_Axioms.md)** — Probability space $(\Omega, \mathcal{F}, P)$, events, and measure mappings
> - **[Functions, Derivatives & Rules](../03-Multivariate-Calculus-and-Optimization/Functions_Derivatives_and_Rules.md)** — Continuous density integration $\int p(x) dx = 1$ and derivative relations $p(x) = F'(x)$
>
