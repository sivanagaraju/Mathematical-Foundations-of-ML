...
> `📚 Prerequisites Needed:` [Entropy, Cross-Entropy & CCE](./01-Entropy_CrossEntropy_CCE.md) (Shannon entropy $H(X) = \mathbb{E}[-\log_2 P(X)]$, surprisal, and prefix code trees) · [Joint, Marginal & Conditional Distributions](../03-Probability-and-Statistical-Estimation/03-Joint_Marginal_Conditional_Dist.md) (Contingency tables, marginal summation $P(x) = \sum_y P(x, y)$, and conditional probability $P(y \mid x) = \frac{P(x, y)}{P(x)}$) · [KL Divergence](./02-KL_Divergence.md) (Relative entropy and information divergence $D_{\text{KL}}(P \parallel Q)$).
...
> Shannon entropy and surprisal from [Module 05, Chapter 01](./01-Entropy_CrossEntropy_CCE.md), joint and conditional probability distributions from [Module 04, Chapter 03](../03-Probability-and-Statistical-Estimation/03-Joint_Marginal_Conditional_Dist.md), and Kullback-Leibler divergence from [Module 05, Chapter 02](./02-KL_Divergence.md).
