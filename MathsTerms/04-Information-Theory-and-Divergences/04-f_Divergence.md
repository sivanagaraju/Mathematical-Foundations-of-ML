...
> `📚 Prerequisites Needed:` [Convexity & Jensen's Inequality](../05-Convexity-Duality-and-Metric-Analysis/01-Convexity_and_Jensens_Inequality.md) (Csiszar generator convex function $f(u)$ where $f(1)=0$ ensuring $D_f(P \parallel Q) \ge 0$) · [KL Divergence](./02-KL_Divergence.md) (Canonical $f$-divergence instance $f(u) = u \ln u$) · [Fenchel Conjugate & Duality](../05-Convexity-Duality-and-Metric-Analysis/03-Fenchel_Conjugate_and_Dual_Representations.md) (Variational dual representation $D_f(P \parallel Q) = \sup_T \mathbb{E}_P[T] - \mathbb{E}_Q[f^*(T)]$)  
...
> Convexity and Jensen's inequality ([Module 01, Chapter 03](../05-Convexity-Duality-and-Metric-Analysis/01-Convexity_and_Jensens_Inequality.md)), KL divergence ([Module 05, Chapter 02](./02-KL_Divergence.md)), and Fenchel conjugates ([Module 01, Chapter 05](../05-Convexity-Duality-and-Metric-Analysis/03-Fenchel_Conjugate_and_Dual_Representations.md)).
