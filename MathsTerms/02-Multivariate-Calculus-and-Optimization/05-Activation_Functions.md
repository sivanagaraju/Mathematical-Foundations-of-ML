...
>    - **[Logarithms & Exponential Functions](../02-Multivariate-Calculus-and-Optimization/00-Logarithms_and_Exponential_Functions.md)** — Logistic sigmoid $\sigma(z) = \frac{1}{1+e^{-z}}$ and softplus.
>    - **[Vectors & Matrices](../01-Linear-Algebra-Geometry-and-Tensors/01-Vectors_and_Matrices.md)** — Affine linear layers $\mathbf{z} = \mathbf{W}\mathbf{x} + \mathbf{b}$.
