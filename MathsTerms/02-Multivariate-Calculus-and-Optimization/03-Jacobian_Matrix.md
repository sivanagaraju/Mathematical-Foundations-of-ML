...
>    - **[Vectors & Matrices](../01-Linear-Algebra-Geometry-and-Tensors/01-Vectors_and_Matrices.md)** — Matrix transformations, coordinate bases, and local linear mappings $\Delta \mathbf{y} \approx \mathbf{J} \Delta \mathbf{x}$.
