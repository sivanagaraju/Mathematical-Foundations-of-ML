...
> `📚 Prerequisites Needed:` [Probability Basics & Axioms](./Probability_Basics_and_Axioms.md) (Probabilities in $[0, 1]$ mapped to log-surprisal / log-likelihood in $(-\infty, 0]$) · [Functions, Derivatives & Rules](../03-Multivariate-Calculus-and-Optimization/Functions_Derivatives_and_Rules.md) (Derivative of exponential $\frac{d}{dx} e^x = e^x$ and natural logarithm $\frac{d}{dx} \ln x = \frac{1}{x}$)
...
> - **[Probability Basics & Axioms](./Probability_Basics_and_Axioms.md)** — Probabilities in $[0, 1]$ mapped to log-surprisal / log-likelihood in $(-\infty, 0]$
> - **[Functions, Derivatives & Rules](../03-Multivariate-Calculus-and-Optimization/Functions_Derivatives_and_Rules.md)** — Derivative of exponential $\frac{d}{dx} e^x = e^x$ and natural logarithm $\frac{d}{dx} \ln x = \frac{1}{x}$
>
