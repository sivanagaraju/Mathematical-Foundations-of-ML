...
> `📚 Prerequisites Needed:` [Random Variables & Distributions](./01-Random_Variables_and_Distributions.md) (Probability density functions $p(x)$, definition of expectation) · [The Chain Rule & Backpropagation](../02-Multivariate-Calculus-and-Optimization/04-Chain_Rule_and_Backpropagation.md) (Computational graphs, gradient flow through functions) · [Functions, Derivatives & Rules](../02-Multivariate-Calculus-and-Optimization/01-Functions_Derivatives_and_Rules.md) (Scalar transformations)  
...
>   - [The Chain Rule & Backpropagation](../02-Multivariate-Calculus-and-Optimization/04-Chain_Rule_and_Backpropagation.md) — Computational graphs, gradient flow through functions
> - **Required for Optional Depth:**
>   - [Functions, Derivatives & Rules](../02-Multivariate-Calculus-and-Optimization/01-Functions_Derivatives_and_Rules.md) — Scalar transformations, integration by substitution, and multivariate Jacobian mappings
