...
> `📚 Prerequisites Needed:` [Vectors & Matrices](../02-Linear-Algebra-Geometry-and-Tensors/Vectors_and_Matrices.md) (Encoder and decoder affine weight matrices $W_e, W_d$) · [Loss Functions in Machine Learning](../03-Multivariate-Calculus-and-Optimization/Loss_Functions.md) (Reconstruction mean squared error $\|x - D(E(x))\|_2^2$) · [Singular Value Decomposition](../02-Linear-Algebra-Geometry-and-Tensors/Singular_Value_Decomposition.md) (Linear autoencoders as low-rank Eckart-Young / PCA subspace projections)
...
> - **[Vectors & Matrices](../02-Linear-Algebra-Geometry-and-Tensors/Vectors_and_Matrices.md)** — Encoder and decoder affine weight matrices $W_e, W_d$
> - **[Loss Functions in Machine Learning](../03-Multivariate-Calculus-and-Optimization/Loss_Functions.md)** — Reconstruction mean squared error $\|x - D(E(x))\|_2^2$
> - **[Singular Value Decomposition](../02-Linear-Algebra-Geometry-and-Tensors/Singular_Value_Decomposition.md)** — Linear autoencoders as low-rank Eckart-Young / PCA subspace projections
>
