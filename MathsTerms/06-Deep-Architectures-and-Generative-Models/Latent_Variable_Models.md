...
> `📚 Prerequisites Needed:` [Joint, Marginal & Conditional Dist](../04-Probability-and-Statistical-Estimation/Joint_Marginal_Conditional_Dist.md) (Joint factorization $p(x, z) = p(x \mid z)p(z)$ and continuous marginalization $\int p(x, z) dz$) · [Likelihood & Log-Likelihood](../04-Probability-and-Statistical-Estimation/Likelihood_and_Log_Likelihood.md) (Marginal likelihood (evidence) optimization and the curse of latent integration)
...
> - **[Joint, Marginal & Conditional Dist](../04-Probability-and-Statistical-Estimation/Joint_Marginal_Conditional_Dist.md)** — Joint factorization $p(x, z) = p(x \mid z)p(z)$ and continuous marginalization $\int p(x, z) dz$
> - **[Likelihood & Log-Likelihood](../04-Probability-and-Statistical-Estimation/Likelihood_and_Log_Likelihood.md)** — Marginal likelihood (evidence) optimization and the curse of latent integration
>
