...
> - **[The Chain Rule & Backpropagation](../03-Multivariate-Calculus-and-Optimization/04-Chain_Rule_and_Backpropagation.md)** — Backpropagation Through Time (BPTT) and vanishing/exploding repeated Jacobian chains $\prod W^T$
> - **[Vectors & Matrices](../02-Linear-Algebra-Geometry-and-Tensors/01-Vectors_and_Matrices.md)** — Hidden state recurrent transition equations $h_t = \tanh(W x_t + U h_{t-1} + b)$
> - **[Activation Functions](../03-Multivariate-Calculus-and-Optimization/05-Activation_Functions.md)** — Hyperbolic tangent $\tanh$ and sigmoid gating non-linearities in LSTM/GRU
>
