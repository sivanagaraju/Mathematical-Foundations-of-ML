...
> `📚 Prerequisites Needed:` [Derivatives, Gradients & Jacobians](./Derivatives_Gradients_and_Jacobians.md) (Loss gradient computation $\nabla_\theta \mathcal{L}$ for gradient-based training) · [Softmax Function](./Softmax.md) (Predicted class probabilities $\hat{y}$ vs one-hot targets $y$ in classification) · [Logarithms & Exponential Functions](../01-Primal-Analysis-and-Foundations/Logarithms_and_Exponential_Functions.md) (Cross-entropy log-penalties and negative log-loss formulation)
...
> - **[Derivatives, Gradients & Jacobians](./Derivatives_Gradients_and_Jacobians.md)** — Loss gradient computation $\nabla_\theta \mathcal{L}$ for gradient-based training
> - **[Softmax Function](./Softmax.md)** — Predicted class probabilities $\hat{y}$ vs one-hot targets $y$ in classification
> - **[Logarithms & Exponential Functions](../01-Primal-Analysis-and-Foundations/Logarithms_and_Exponential_Functions.md)** — Cross-entropy log-penalties and negative log-loss formulation
>
