...
> `📚 Prerequisites Needed:` [Logarithms & Exponential Functions](../01-Primal-Analysis-and-Foundations/Logarithms_and_Exponential_Functions.md) (Natural exponential function $e^z > 0$ and LogSumExp numerical stability) · [Vectors & Matrices](../02-Linear-Algebra-Geometry-and-Tensors/Vectors_and_Matrices.md) (Pre-softmax logit score vectors $z \in \mathbb{R}^K$ from linear layer outputs) · [Probability Basics & Axioms](../01-Primal-Analysis-and-Foundations/Probability_Basics_and_Axioms.md) (Discrete probability axioms: non-negativity $p_i \ge 0$ and normalization $\sum p_i = 1.0$)
...
> - **[Logarithms & Exponential Functions](../01-Primal-Analysis-and-Foundations/Logarithms_and_Exponential_Functions.md)** — Natural exponential function $e^z > 0$ and LogSumExp numerical stability
> - **[Vectors & Matrices](../02-Linear-Algebra-Geometry-and-Tensors/Vectors_and_Matrices.md)** — Pre-softmax logit score vectors $z \in \mathbb{R}^K$ from linear layer outputs
> - **[Probability Basics & Axioms](../01-Primal-Analysis-and-Foundations/Probability_Basics_and_Axioms.md)** — Discrete probability axioms: non-negativity $p_i \ge 0$ and normalization $\sum p_i = 1.0$
>
