...
> `📚 Prerequisites Needed:` [Softmax Function](./Softmax.md) (Logit temperature scaling and annealed convergence $\lim_{\tau \to 0} \text{Softmax}(z/\tau) = \text{one-hot}(\arg\max z)$) · [Random Variables & Distributions](../04-Probability-and-Statistical-Estimation/Random_Variables_and_Distributions.md) (Categorical distributions, Gumbel noise perturbation, and the Gumbel-Max trick) · [Derivatives, Gradients & Jacobians](./Derivatives_Gradients_and_Jacobians.md) (Zero gradient pathology of step functions blocking backpropagation)
...
> - **[Softmax Function](./Softmax.md)** — Logit temperature scaling and annealed convergence $\lim_{\tau \to 0} \text{Softmax}(z/\tau) = \text{one-hot}(\arg\max z)$
> - **[Random Variables & Distributions](../04-Probability-and-Statistical-Estimation/Random_Variables_and_Distributions.md)** — Categorical distributions, Gumbel noise perturbation, and the Gumbel-Max trick
> - **[Derivatives, Gradients & Jacobians](./Derivatives_Gradients_and_Jacobians.md)** — Zero gradient pathology of step functions blocking backpropagation
>
