...
> - **[Vectors & Matrices](../02-Linear-Algebra-Geometry-and-Tensors/01-Vectors_and_Matrices.md)** — Matrix transformations, coordinate spaces, and local linear mappings $\Delta \vec{y} \approx J \Delta \vec{x}$
>
