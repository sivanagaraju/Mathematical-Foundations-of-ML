...
> `📚 Prerequisites Needed:` [Gradient Descent & Optimizers](./Gradient_Descent.md) (SGD noisy parameter trajectories, weight oscillations, and Adam momentum) · [Vectors & Matrices](../02-Linear-Algebra-Geometry-and-Tensors/Vectors_and_Matrices.md) (Convex combinations of parameter weight vectors $\theta_{\text{EMA}} = \beta \theta_{\text{EMA}} + (1-\beta)\theta$)
...
> - **[Gradient Descent & Optimizers](./Gradient_Descent.md)** — SGD noisy parameter trajectories, weight oscillations, and Adam momentum
> - **[Vectors & Matrices](../02-Linear-Algebra-Geometry-and-Tensors/Vectors_and_Matrices.md)** — Convex combinations of parameter weight vectors $\theta_{\text{EMA}} = \beta \theta_{\text{EMA}} + (1-\beta)\theta$
>
